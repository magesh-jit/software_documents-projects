...
WebUI.click(findTestObject('Object Repository/Page_nopCommerce demo store/a_Log in'))

WebUI.setText(findTestObject('Object Repository/Page_nopCommerce demo store. Login/input_Email_Email'), GlobalVariable.email)
